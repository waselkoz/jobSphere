    ...
    return (
        <div className="min-h-[calc(100vh-80px)] flex items-center justify-center px-4">
            <div className="w-full max-w-md p-8 bg-white/60 dark:bg-white/5 backdrop-blur-xl border border-blue-200 dark:border-white/10 rounded-2xl shadow-2xl">
                <h2 className="text-3xl font-bold mb-6 text-center text-slate-900 dark:text-white">Join JobSphere</h2>
                {error && (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        <label className="block text-sm font-medium text-slate-700 dark:text-amber-100/80 mb-1">Username</label>
                        <input
                            type="text"
                            required
                    ...
                    <div>
                        <label className="block text-sm font-medium text-slate-700 dark:text-amber-100/80 mb-1">Join as</label>
                        <select
                            className="w-full px-4 py-3 bg-white/50 dark:bg-black/60 border border-blue-200 dark:border-amber-500/20 rounded-lg focus:outline-none focus:border-blue-500 dark:focus:border-amber-500 text-slate-900 dark:text-white appearance-none cursor-pointer"
                    ...
                    <button className="w-full py-3 bg-gradient-to-r from-blue-600 to-cyan-500 dark:from-amber-600 dark:to-yellow-500 hover:shadow-lg hover:shadow-blue-600/20 dark:hover:shadow-amber-600/20 text-white dark:text-black font-bold rounded-lg transition-all mt-6 border border-blue-400/20 dark:border-amber-400/20">
                        Create Account
                    </button>
                </form>
                <div className="relative my-6">
                    ...
                    <div className="relative flex justify-center text-sm">
                        <span className="px-2 bg-slate-50 dark:bg-black text-slate-500">Or join with</span>
                    </div>
                </div>
                ...
                <p className="mt-6 text-center text-slate-600 dark:text-amber-200/60 text-sm">
                    ...
                    <Link to="/login" className="text-blue-600 dark:text-amber-400 hover:text-blue-500 dark:hover:text-amber-300 font-semibold">Sign In</Link>
                </p>
            </div>
        </div>
    )
